...
public class LabNo2 {
	...
	public static void main(String[] args) {
		...
		String goEastEmpty = "Yarrrr!!! You really are " + playerName + ", The Brave! Or just stupid enough to go after Kraken. But let's cut off the drama. In fact, the Kraken is just an overgrown squid on steroids but still dangerous! You fired at him with with all of your firepower and damaged him but not enough to kill. Luckily you managed to escape in one piece. Maybe if you had enough people... Who knows? Well, at least you survived. You still can go anywhere you like: west to search for the treasure island, north to the unknown, south to pillage the port town. Or you want to push your luck and go east again for the second time? It's up to you.";
		...
		System.out.println(playerName + ", would you like to play a game?");
